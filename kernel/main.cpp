...
extern "C" void KernelMain(const FrameBufferConfig& frame_buffer_config) {
    ...
    const uint8_t bsp_local_apic_id = *reinterpret_cast<const uint32_t*>(0xfee00020) >> 24; // プログラムが動作しているコアのidを取得
    pci::ConfigureMSIFixedDestination(
      *xhc_dev,
      bsp_local_apic_id, // コアid
      pci::MSITriggerMode::kLevel, pci::MSIDeliveryMode::kFixed,
      InterruptVector::kXHCI, // 割り込みベクタ番号
      0);
